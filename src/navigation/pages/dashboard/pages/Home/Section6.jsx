          ...
          <Carousel>
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  " This is the best and most growing platform in the food ordering industry "
                </p>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  " This platform has helped us to grow sales to up to 80% "
                </p>
                <div className="item_rating mb-2">
                  <i className="bi bi-star-fill"></i>
                  <i className="bi bi-star-fill"></i>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  " This platform is very reliable on time and they really stick to it "
                </p>
                <div className="item_rating mb-2">
                  <i className="bi bi-star-fill"></i>
                  <i className="bi bi-star-fill"></i>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                ...
                <p>
                  " This platform is very user-friendly and easy to use "
                </p>
                <div className="item_rating mb-2">
                  <i className="bi bi-star-fill"></i>
                  <i className="bi bi-star-fill"></i>
